...
data_root = '/data/diving48/rgb/'
data_root_val = '/data/diving48/rgb/'
ann_file_train = '/data/diving48/train_v2.txt'
ann_file_val = '/data/diving48/test_v2.txt'
ann_file_test = '/data/diving48/test_v2.txt'
img_norm_cfg = dict(
...
work_dir = './work_dirs/diving48_swin_tiny_2D_tps_patternC.py'
